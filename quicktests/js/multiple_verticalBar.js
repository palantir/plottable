window.onload = function() {
    ...
    PAPlot = new Plottable.Plot.VerticalBar(data1, xScale, yScale)
      .animate(true) 
      .project("x", "month", xScale)
      .project("y", "avg", yScale)
      .project("fill", "city", colorScale);
         
    SFPlot = new Plottable.Plot.VerticalBar(data2, xScale, yScale)
      .animate(true) 
      .project("x", "month", xScale)
      .project("y", "avg", yScale)
      .project("fill", "city", colorScale);

    SJPlot = new Plottable.Plot.VerticalBar(data3, xScale, yScale)
      .animate(true) 
      .project("x", "month", xScale)
      .project("y", "avg", yScale)
      .project("fill", "city", colorScale);             
