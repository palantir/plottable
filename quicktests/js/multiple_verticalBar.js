...
function run(div, data, Plottable){
  ...
  var PAPlot = new Plottable.Plot.VerticalBar(data[0], xScale, yScale)
    .animate(true) 
    .project("x", "month", xScale)
    .project("y", "avg", yScale)
    .project("fill", "city", colorScale);
       
  var SFPlot = new Plottable.Plot.VerticalBar(data[1], xScale, yScale)
    .animate(true) 
    .project("x", "month", xScale)
    .project("y", "avg", yScale)
    .project("fill", "city", colorScale);

  var SJPlot = new Plottable.Plot.VerticalBar(data[2], xScale, yScale)
    .animate(true) 
    .project("x", "month", xScale)
    .project("y", "avg", yScale)
    .project("fill", "city", colorScale);             
