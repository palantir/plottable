...
var quicktest = function(svg, data, Plottable) {
        ...
        var renderAreaD1 = new Plottable.Renderer.Area(dataseries, xScale, yScale);
        var renderAreaD2 = new Plottable.Renderer.Area(dataseries_top, xScale, yScale, "x", "y", y0Accessor);
