...
function run(svg, data, Plottable){
  "use strict";
    ...
    var title_t = new Plottable.Component.Label("n = new point, d = delete point, c = clear");
    var title_b = new Plottable.Component.Label("Press '0'-'5' to mark selection[x]");    
    ...
    hover.onHoverOut(function(hoverData) {
      title_t.text("n = new point, d = delete point, c = clear");
    });
    ...
    key.on(48, function(keyData){
        append(48); 
    });
    key.on(49, function(keyData){
        append(49); 
    });
    key.on(50, function(keyData){
        append(50); 
    });
    key.on(51, function(keyData){
        append(51); 
    });
    key.on(52, function(keyData){
        append(52); 
    });
    key.on(53, function(keyData){
        append(53); 
    });
