...
module Plottable {
  export class QuantitativeScale<D> extends Scale<D, number> {
    ...
    public invert(value: number): D {
      return <any> (<D3.Scale.QuantitativeScale | D3.Scale.TimeScale> this._d3Scale).invert(value);
    }
    ...
    public getDefaultTicks(): D[] {
      return (<D3.Scale.QuantitativeScale | D3.Scale.TimeScale> this._d3Scale).ticks(QuantitativeScale._DEFAULT_NUM_TICKS);
    }
    ...
    public _niceDomain(domain: D[], count?: number): D[] {
      return (<D3.Scale.QuantitativeScale | D3.Scale.TimeScale> this._d3Scale).copy().domain(domain).nice(count).domain();
    }
