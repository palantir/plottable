...
export module Abstract {
  export interface TickGenerator {
    (scale: Plottable.Abstract.QuantitativeScale<any>): any[]
  }
  ...
  export class QuantitativeScale<D> extends Scale<D, number> {
    ...
    public _tickGenerator: TickGenerator = (scale: Plottable.Abstract.QuantitativeScale<D>) => scale.getDefaultTicks();
