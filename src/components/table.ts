...
export module Components {
  ...
  export class Table extends ComponentContainer {
     ...
     */
      ...
      var rowWeights = Table._calcComponentWeights(this._rowWeights, rows, (c: Component) => (c == null) || c.hasFixedHeight());
      var colWeights = Table._calcComponentWeights(this._colWeights,  cols, (c: Component) => (c == null) || c.hasFixedWidth());
    ...
    public hasFixedWidth(): boolean {
      var cols = d3.transpose(this._rows);
      return Table._fixedSpace(cols, (c: Component) => (c == null) || c.hasFixedWidth());
    }

    public hasFixedHeight(): boolean {
      return Table._fixedSpace(this._rows, (c: Component) => (c == null) || c.hasFixedHeight());
    }
