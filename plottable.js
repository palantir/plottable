...
(function (Plottable) {
    ...
    var StackedPlotUtils = (function () {
        ...
        StackedPlotUtils.updateStackExtents = function (keyAccessor, valueAccessor, datasetKeys, keyToPlotDatasetKey, filter) {
...
(function (Plottable) {
    var Stacked = (function (_super) {
        ...
        Stacked.prototype._updateStackOffsets = function (keyAccessor, valueAccessor, datasetKeys, keyToPlotDatasetKey) {
        ...
        var StackedArea = (function (_super) {
            ...
            StackedArea.prototype._updateExtentsForProperty = function (property) {
                ...
                if ((property === "x" || property === "y") && this._projectorsReady()) {
                    ...
                    var extents = Plottable.StackedPlotUtils.updateStackExtents(keyAccessor, valueAccessor, datasetKeys, keyToPlotDatasetKey, filter);
            ...
            StackedArea.prototype._doStackUpdate = function () {
                var orientation = this._isVertical ? "vertical" : "horizontal";
                var keyAccessor = Plottable.StackedPlotUtils.keyAccessor(this, orientation);
                var valueAccessor = Plottable.StackedPlotUtils.valueAccessor(this, orientation);
                var datasetKeys = this._datasetKeysInOrder;
            ...
            StackedArea.prototype._updateStackOffsets = function () {
                ...
                Plottable.Stacked.prototype._updateStackOffsets.call(this, keyAccessor, valueAccessor, datasetKeys, keyToPlotDatasetKey);
            };
            return StackedArea;
        })(Plots.Area);
...
(function (Plottable) {
    ...
    (function (Plots) {
        var StackedBar = (function (_super) {
            ...
            StackedBar.prototype._doStackUpdate = function () {
                var orientation = this._isVertical ? "vertical" : "horizontal";
                var keyAccessor = Plottable.StackedPlotUtils.keyAccessor(this, orientation);
                var valueAccessor = Plottable.StackedPlotUtils.valueAccessor(this, orientation);
                var datasetKeys = this._datasetKeysInOrder;
