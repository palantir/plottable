...
(function (Plottable) {
    var QuantitativeScale = (function (_super) {
        ...
        QuantitativeScale.prototype._computeClampedDomain = function (values) {
            // HACKHACK: TS1.4 doesn't consider numbers to be Number-like (valueOf() returning number), so D can't be typed correctly
            var extent = Math.abs(values[1].valueOf() - values[0].valueOf());
        ...
        QuantitativeScale.prototype._computeDomainWithExtent = function (domain, extent) {
            return domain;
        };
        /**
...
(function (Plottable) {
    ...
    (function (Scales) {
        var Linear = (function (_super) {
            ...
            Linear.prototype._computeDomainWithExtent = function (domain, extent) {
...
(function (Plottable) {
    ...
    (function (Scales) {
        var ModifiedLog = (function (_super) {
            ...
            ModifiedLog.prototype._computeDomainWithExtent = function (domain, extent) {
                var domainCenter = (domain[1] + domain[0]) / 2;
                var domainMin = domainCenter - extent / 2;
                var domainMax = domainCenter + extent / 2;
                return domain[1] > domain[0] ? [domainMin, domainMax] : [domainMax, domainMin];
...
(function (Plottable) {
    ...
    (function (Scales) {
        var Time = (function (_super) {
            ...
            Time.prototype._computeDomainWithExtent = function (domain, extent) {
