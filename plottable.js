    ...
    (function (Dispatcher) {
        var Wheel = (function (_super) {
            ...
            function Wheel(svg) {
                ...
                this._processWheelCallback = function (e) { return _this._processWheel(e); };
             ...
             */
            Wheel.getDispatcher = function (elem) {
                var svg = Plottable._Util.DOM.getBoundingSVG(elem);
                var dispatcher = svg[Wheel._DISPATCHER_KEY];
                if (dispatcher == null) {
                    dispatcher = new Wheel(svg);
                    svg[Wheel._DISPATCHER_KEY] = dispatcher;
                }
                return dispatcher;
            };
            Wheel.prototype._getWrappedCallback = function (callback) {
                return function (wd, e) { return callback(e.deltaY, e); };
            };
            /**
             ...
             */
            Wheel.prototype.onWheel = function (key, callback) {
                this._setCallback(this._wheelBroadcaster, key, callback);
                return this;
            };
            Wheel.prototype._processWheel = function (e) {
                this._wheelBroadcaster.broadcast(e);
            };
            Wheel._DISPATCHER_KEY = "__Plottable_Dispatcher_Wheel";
            return Wheel;
        })(Dispatcher.AbstractDispatcher);
