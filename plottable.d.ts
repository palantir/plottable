...
declare module Plottable {
    class QuantitativeScale<D> extends Scale<D, number> {
        ...
        extentOfValues(values: D[]): D[];
        protected _setDomain(values: D[]): void;
        protected _computeDomainWithExtent(domain: D[], extent: number): D[];
        /**
...
declare module Plottable {
    module Scales {
        class Linear extends QuantitativeScale<number> {
            ...
            protected _computeDomainWithExtent(domain: number[], extent: number): number[];
        }
    }
}
...
declare module Plottable {
    module Scales {
        class Time extends QuantitativeScale<Date> {
            ...
            protected _computeDomainWithExtent(domain: Date[], extent: number): Date[];
        }
    }
}
