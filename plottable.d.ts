...
declare module Plottable {
    class Domainer {
         ...
         *                 pair.
         */
        computeDomain(extents: any[][], scale: Quantitative<any>): any[];
        /**
...
declare module Plottable {
    class Quantitative<D> extends Scale<D, number> {
         ...
         */
        tickGenerator(generator: Scales.TickGenerators.TickGenerator<D>): Quantitative<D>;
    }
}
    ...
    module Scales {
        module TickGenerators {
            interface TickGenerator<D> {
                (scale: Plottable.Quantitative<D>): D[];
            }
            /**
...
declare module Plottable {
    module Axes {
        class Numeric extends Axis {
             ...
             */
            constructor(scale: Quantitative<number>, orientation: string, formatter?: (d: any) => string);
            protected _setup(): void;
