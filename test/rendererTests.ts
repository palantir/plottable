    ...
    describe("Bar Plot", () => {
      ...
      describe("Horizontal Bar Plot in Bands mode", () => {
        ...
        it("renders correctly", () => {
          ...
          assert.closeTo(numAttr(bar0, "y") + numAttr(bar0, "height") / 2, yScale.scale(bar0y) + bandWidth / 2,
                         0.01, "y pos correct for bar0");
          assert.closeTo(numAttr(bar1, "y") + numAttr(bar1, "height") / 2, yScale.scale(bar1y) + bandWidth / 2,
                         0.01, "y pos correct for bar1");
          verifier.end();
        });
