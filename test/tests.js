...
describe("Plots", function () {
    ...
    describe("fail safe tests", function () {
        ...
        it("bad values on the primary axis should default to 0 (be ignored)", function () {
            ...
            var offset4 = plot._key2PlotDatasetKey.get(keys[4]).plotMetadata.offsets.get("A");
...
describe("Metadata", function () {
    ...
    it("plot metadata is set properly", function () {
        ...
        var r = new Plottable.Plot().addDataset(d1).addDataset(d2);
...
describe("Scales", function () {
    describe("Linear Scales", function () {
        ...
        it("domainMin()", function () {
            ...
            assert.deepEqual(scale.domain(), [minAboveTop, minAboveTop + 1], "domain is set to [min, min + 1] if the requested value is above autoDomain()-ed max value");
            scale.autoDomain();
        ...
        it("domainMax()", function () {
            ...
            assert.deepEqual(scale.domain(), [maxBelowBottom - 1, maxBelowBottom], "domain is set to [max - 1, max] if the requested value is below autoDomain()-ed min value");
            scale.autoDomain();
...
describe("Scales", function () {
    describe("Modified Log Scale", function () {
        ...
        it("domainMin()", function () {
            ...
            var minAboveTop = 10;
            scale.domainMin(minAboveTop);
            assert.deepEqual(scale.domain(), [minAboveTop, minAboveTop * base], "domain is set to [min, min * base] if the requested value is above autoDomain()-ed max value");
            scale.autoDomain();
            assert.deepEqual(scale.domain(), requestedDomain, "calling autoDomain() overrides domainMin()");
            scale.domainMin(minInMiddle);
            var requestedDomain2 = [-10, 10];
        ...
        it("domainMax()", function () {
            ...
            var maxBelowBottom = -10;
            scale.domainMax(maxBelowBottom);
            assert.deepEqual(scale.domain(), [maxBelowBottom / base, maxBelowBottom], "domain is set to [max / base, max] if the requested value is below autoDomain()-ed min value");
            scale.autoDomain();
            assert.deepEqual(scale.domain(), requestedDomain, "calling autoDomain() overrides domainMax()");
            scale.domainMax(maxInMiddle);
            var requestedDomain2 = [-10, 10];
