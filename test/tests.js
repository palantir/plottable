...
var assert = chai.assert;
describe("Plots", function () {
    describe("ErrorBar Plot", function () {
        var svg;
        var data = [
        ...
        var SVG_WIDTH = 600;
        var SVG_HEIGHT = 400;
        describe("Vertical ErrorBar Plot", function () {
            var xScale;
            var yScale;
            var barPlot;
            var errorBarPlot;
            ...
            it("renders error bars in the vertical direction", function () {
                var errorBarRenderArea = errorBarPlot._renderArea;
        ...
        describe("Horizontal ErrorBar Plot", function () {
            var xScale;
            var yScale;
            var barPlot;
            var errorBarPlot;
