...
describe("Plots", function () {
    describe("AreaPlot", function () {
        ...
        it("correctly handles NaN and undefined x and y values", function () {
            ...
            areaPathStrings.pop();
            var areaPathPoints = areaPathStrings.map(function (path) { return path.split(/[A-Z]/).map(function (point) { return point.split(","); }); });
            areaPathPoints.forEach(function (areaPathPoint) { return areaPathPoint.shift(); });
            ...
            areaPathStrings.pop();
            areaPathPoints = areaPathStrings.map(function (path) { return path.split(/[A-Z]/).map(function (point) { return point.split(","); }); });
            areaPathPoints.forEach(function (areaPathPoint) { return areaPathPoint.shift(); });
