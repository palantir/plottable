...
describe("Plots", function () {
    describe("StackedBar Plot Stacking", function () {
        ...
        it("uses positive offset on stacking the 0 value", function () {
            ...
            var stackOffset1 = stackedPlot._stackInformation.get(ds1);
            var stackOffset4 = stackedPlot._stackInformation.get(ds4);
        ...
        it("strings are coerced to numbers for stacking", function () {
            ...
            var stackOffset2 = stackedPlot._stackInformation.get(ds2);
            var stackOffset3 = stackedPlot._stackInformation.get(ds3);
            var stackOffset4 = stackedPlot._stackInformation.get(ds4);
            var stackOffset5 = stackedPlot._stackInformation.get(ds5);
...
describe("Plots", function () {
    ...
    describe("fail safe tests", function () {
        it("0 as a string coerces correctly and is not subject to off by one errors", function () {
            ...
            var ds0Point2Offset = plot._stackInformation.get(dataset0).get("2").offset;
            var ds1Point2Offset = plot._stackInformation.get(dataset1).get("2").offset;
            var ds2Point2Offset = plot._stackInformation.get(dataset2).get("2").offset;
...
describe("Plots", function () {
    ...
    describe("fail safe tests", function () {
        it("conversion fails should be silent in Plot.StackedBar", function () {
            ...
            plot.attr("fill", "fill");
            plot.x(function (d) { return d.x; }, xScale).y(function (d) { return d.y; }, yScale);
            var ds1FirstColumnOffset = plot._stackInformation.get(ds1).get("A").offset;
            var ds2FirstColumnOffset = plot._stackInformation.get(ds2).get("A").offset;
        ...
        it("bad values on the primary axis should default to 0 (be ignored)", function () {
            ...
            plot.attr("fill", "fill");
            plot.x(function (d) { return d.x; }, xScale).y(function (d) { return d.y; }, yScale);
            var offset0 = plot._stackInformation.get(ds1).get("A").offset;
            var offset2 = plot._stackInformation.get(ds3).get("A").offset;
            var offset4 = plot._stackInformation.get(ds5).get("A").offset;
...
describe("Utils", function () {
    describe("StackingUtils", function () {
        ...
        it("computeStackInformation() works as expected with positive values", function () {
        ...
        it("computeStackInformation() works as expected with negative values", function () {
            var data1 = [{ key: "Fred", value: -1 }];
            var data2 = [{ key: "Fred", value: -1 }];
            var data3 = [{ key: "Fred", value: -3 }];
            var data4 = [{ key: "Fred", value: 0 }];
        ...
        it("computeStackInformation() works as expected with positive and negative values", function () {
            var data1 = [{ key: "Fred", value: 1 }];
