...
describe("Legends", function () {
    ...
    describe("Legend hover tests", function () {
        ...
        it("hoverLegend.scale() works as intended", function () {
            var domain = ["a", "b", "c", "d", "e"];
            color.domain(domain);
            hoverLegend.renderTo(svg);
            toggleEntry("a", 0);
        ...
        it("Testing callback works correctly", function () {
            ...
            hoverLegend.toggleCallback(function (d, b) {
                state[domain.indexOf(d)] = b;
            });
            hoverLegend.renderTo(svg);
        ...
        it("Removing callback is successful", function () {
            ...
            hoverLegend.toggleCallback(); // this should not remove the callback
            toggleEntry("a", 0);
            assert.equal(state, true, "callback was successful");

            hoverLegend.toggleCallback(null); // this should remove the callback
            assert.throws(function () {
                toggleEntry("a", 0);
            }, "not a function");
            var selection = getSelection("a");
