  ...
  describe("constrained to component behavior", () => {
    ...
    describe("callbacks when constrain is enabled", () => {
      [TestMethods.InteractionMode.Mouse, TestMethods.InteractionMode.Touch].forEach((mode: TestMethods.InteractionMode) => {
        ...
        it("does not constrain dragging for onDrag outside Component in positive direction for " + TestMethods.InteractionMode[mode], () => {
        ...
        it("does not constrain dragging for onDrag outside Component in negative direction for " + TestMethods.InteractionMode[mode], () => {
        ...
        it("does not constrain dragging for onDragEnd outside Component in positive direction for " + TestMethods.InteractionMode[mode], () => {
          dragEnd(startPoint, positiveOutsidePoint);
          
          assert.deepEqual(callback.getEndPoint(), positiveOutsidePoint, "was passed the correct end point");
        });
        
        it("does not constrain dragging for onDragEnd outside Component in negative direction for " + TestMethods.InteractionMode[mode], () => {
