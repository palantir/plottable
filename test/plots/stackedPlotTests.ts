...
describe("Plots", () => {
  ...
  describe("StackedBar Plot Stacking", () => {
    ...
    it("uses positive offset on stacking the 0 value", () => {
      ...
      let stackOffset1 = (<any> stackedPlot)._plot.stackingResult().get(ds1);
      let stackOffset4 = (<any> stackedPlot)._plot.stackingResult().get(ds4);
    ...
    it("strings are coerced to numbers for stacking", () => {
      ...
      let stackOffset2 = (<any> stackedPlot)._plot.stackingResult().get(ds2);
      let stackOffset3 = (<any> stackedPlot)._plot.stackingResult().get(ds3);
      let stackOffset4 = (<any> stackedPlot)._plot.stackingResult().get(ds4);
      let stackOffset5 = (<any> stackedPlot)._plot.stackingResult().get(ds5);
      ...
      assert.deepEqual((<any> stackedPlot)._plot._stackedExtent, [-4, 9], "stacked extent is as normal");
    });
  ...
  describe("StackedArea Plot Stacking", () => {
    ...
    it("uses positive offset on stacking the 0 value", () => {
      ...
      let stackOffset1 = (<any> stackedPlot)._plot._stackingResult.get(ds1);
      let stackOffset4 = (<any> stackedPlot)._plot._stackingResult.get(ds4);
      assert.strictEqual(stackOffset1.get("1").offset, 1, "positive offset was used");
      assert.strictEqual(stackOffset4.get("1").offset, 2, "positive offset was used");
    });
    ...
    it("strings are coerced to numbers for stacking", () => {
      ...
      let stackOffset2 = (<any> stackedPlot)._plot._stackingResult.get(ds2);
      let stackOffset3 = (<any> stackedPlot)._plot._stackingResult.get(ds3);
      let stackOffset4 = (<any> stackedPlot)._plot._stackingResult.get(ds4);
      let stackOffset5 = (<any> stackedPlot)._plot._stackingResult.get(ds5);
