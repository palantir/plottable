    ...
    describe("Vertical ErrorBar Plot", () => {
      ...
      it("renders error bars in the vertical direction", () => {
        ...
        errorBars.each(function() {
          ...
          assert.closeTo(+errorBarUpper.attr("x1") + (+errorBarUpper.attr("x2") - +errorBarUpper.attr("x1")) / 2,
              +errorBarMiddle.attr("x1"), 0.5, "error-bar-middle is properly positioned relative to error-bar-upper");
          assert.closeTo(+errorBarLower.attr("x1") + (+errorBarLower.attr("x2") - +errorBarLower.attr("x1")) / 2,
              +errorBarMiddle.attr("x1"), 0.5, "error-bar-middle is properly positioned relative to error-bar-lower");
        });
        svg.remove();
      });
    });
    ...
    describe("Horizontal ErrorBar Plot", () => {
      ...
      it("renders error bars in the horizontal direction", () => {
        ...
        errorBars.each(function() {
          ...
          assert.closeTo(+errorBarUpper.attr("y1") + (+errorBarUpper.attr("y2") - +errorBarUpper.attr("y1")) / 2,
              +errorBarMiddle.attr("y1"), 0.5, "error-bar-middle is properly positioned relative to error-bar-upper");
          assert.closeTo(+errorBarLower.attr("y1") + (+errorBarLower.attr("y2") - +errorBarLower.attr("y1")) / 2,
              +errorBarMiddle.attr("y1"), 0.5, "error-bar-middle is properly positioned relative to error-bar-lower");
        });
        svg.remove();
      });
    });
