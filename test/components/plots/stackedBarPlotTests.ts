...
describe("Plots", () => {
  ...
  describe("fail safe tests", () => {
    ...
    it("conversion fails should be silent in Plot.StackedBar", () => {
      ...
      var ds1FirstColumnOffset = (<any> plot)._stackOffsets.get(ds1).get("A").offset;
      var ds2FirstColumnOffset = (<any> plot)._stackOffsets.get(ds2).get("A").offset;
    ...
    it("bad values on the primary axis should default to 0 (be ignored)", () => {
      ...
      var offset0 = (<any> plot)._stackOffsets.get(ds1).get("A").offset;
      var offset2 = (<any> plot)._stackOffsets.get(ds3).get("A").offset;
      var offset4 = (<any> plot)._stackOffsets.get(ds5).get("A").offset;
