...
describe("Plots", () => {
  ...
  describe("fail safe tests", () => {
    it("0 as a string coerces correctly and is not subject to off by one errors", () => {
      ...
      var ds1Point2Offset = (<any> plot).key2PlotDatasetKey.get("d1").plotMetadata.offsets.get(2);
      var ds2Point2Offset = (<any> plot).key2PlotDatasetKey.get("d2").plotMetadata.offsets.get(2);
      var ds3Point2Offset = (<any> plot).key2PlotDatasetKey.get("d3").plotMetadata.offsets.get(2);
