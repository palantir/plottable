...
describe("Plots", () => {
  ...
  describe("Stacked Plot Stacking", () => {
    ...
    it("uses positive offset on stacking the 0 value", () => {
      ...
      var ds2PlotMetadata = <Plottable.Plots.StackedPlotMetadata>(<any> stackedPlot).datasetKeys.get("d2").plotMetadata;
      var ds5PlotMetadata = <Plottable.Plots.StackedPlotMetadata>(<any> stackedPlot).datasetKeys.get("d5").plotMetadata;
    ...
    it("uses negative offset on stacking the 0 value on all negative/0 valued data", () => {
      ...
      var ds2PlotMetadata = <Plottable.Plots.StackedPlotMetadata>(<any> stackedPlot).datasetKeys.get("d2").plotMetadata;
      var ds4PlotMetadata = <Plottable.Plots.StackedPlotMetadata>(<any> stackedPlot).datasetKeys.get("d4").plotMetadata;
    ...
    it("project can be called after addDataset", () => {
      ...
      stackedPlot.addDataset("d1", data1);
      stackedPlot.addDataset("d2", data2);
      var ds1PlotMetadata = <Plottable.Plots.StackedPlotMetadata>(<any> stackedPlot).datasetKeys.get("d1").plotMetadata;
      var ds2PlotMetadata = <Plottable.Plots.StackedPlotMetadata>(<any> stackedPlot).datasetKeys.get("d2").plotMetadata;
    ...
    it("strings are coerced to numbers for stacking", () => {
      ...
      var ds3PlotMetadata = <Plottable.Plots.StackedPlotMetadata>(<any> stackedPlot).datasetKeys.get("d3").plotMetadata;
      var ds4PlotMetadata = <Plottable.Plots.StackedPlotMetadata>(<any> stackedPlot).datasetKeys.get("d4").plotMetadata;
      var ds5PlotMetadata = <Plottable.Plots.StackedPlotMetadata>(<any> stackedPlot).datasetKeys.get("d5").plotMetadata;
      var ds6PlotMetadata = <Plottable.Plots.StackedPlotMetadata>(<any> stackedPlot).datasetKeys.get("d6").plotMetadata;
