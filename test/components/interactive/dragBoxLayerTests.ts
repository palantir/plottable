...
describe("Interactive Components", () => {
  describe("DragBoxLayer", () => {
    ...
    it("correctly draws box on drag", () => {
      ...
      var dbl = new Plottable.Components.Interactive.DragBoxLayer();
      dbl.renderTo(svg);
    ...
    describe("resizing", () => {
      ...
      var dbl: Plottable.Components.Interactive.DragBoxLayer;
      ...
      beforeEach(() => {
        ...
        dbl = new Plottable.Components.Interactive.DragBoxLayer();
        dbl.renderTo(svg);
