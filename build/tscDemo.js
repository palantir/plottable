...
(function (TSCDemo) {
    ...
    var chart = new Plottable.Table().addComponent(0, 0, left).addComponent(0, 1, lineRenderer).addComponent(1, 1, bottomAxis);

    var outerTable = new Plottable.Table().addComponent(0, 0, new Plottable.TitleLabel("A Chart")).addComponent(1, 0, chart);
