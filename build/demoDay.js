...
(function (DemoDay) {
    ...
    function makeScatterHisto(data) {
        ...
        var titleRow = [
            new Plottable.TitleLabel("Random Data").classed("scatterplot-title", true),
    ...
    function coordinator(chart, dataset) {
        ...
        var zoomCallback = new Plottable.ZoomCallbackGenerator().addXScale(scatterplot.xSpark, scatterplot.xScale).addYScale(scatterplot.ySpark, scatterplot.yScale).getCallback();
