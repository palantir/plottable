window.onload = function() {
  ...
  var renderAreaD1 = new CircleRenderer(dataseries1, xScale, yScale1).classed("series-1");
  var renderAreaD2 = new CircleRenderer(dataseries2, xScale, yScale2).classed("series-2");

  var basicTable = new Table([[yAxis, renderAreaD1, null],
