...
module SparklineDemo {
  ...
  var r1: Plottable.Component[] = [left, renderer];
  var r2: Plottable.Component[] = [null, bottomAxis];
  var r3: Plottable.Component[] = [null, sparkline];

  var chart = new Plottable.Table([r1, r2, r3]);
  chart.rowWeight(2, 0.25);

  var zoomCallback = new Plottable.ZoomCallbackGenerator()
